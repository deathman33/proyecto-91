...
function car1_up()
{
	...
	{
		car1_y = car1_y - 10;
		console.log("cuando se presione la flecha arriba, x = " + car1_x + " l Y = " +car1_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car1_down()
{
	...
	{
		car1_y = car1_y + 10;
		console.log("cuando se presione la flecha abajo, x = " + car1_x + " l Y = " +car1_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car1_left()
{
	...
	{
		car1_x = car1_x - 10;
		console.log("cuando se presione la flecha izquierda, x = " + car1_x + " l Y = " +car1_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car1_right()
{
	...
	{
		car1_x = car1_x + 10;
		console.log("cuando se presione la flecha derecha, x = " + car1_x + " l Y = " +car1_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
if(car1_x > 700)
{
	console.log('game_status').innerHTML = "¡Gana el auto 1!";
}

if(car2_x > 700)
{
	console.log('game_status').innerHTML = "¡Gana el auto 2!";
}